 ...
 */
export class FilterMapDivReduce extends TemplateMethod {
  /**
  ...
  beforeReduce(mappedNumbers: number[]): string | void {
    console.log("Vamos a aplicar \"reduce\" con una división a los números ya filtrados y transformados:", mappedNumbers);
    return "Vamos a aplicar \"reduce\" con una división a los números ya filtrados y transformados: " + mappedNumbers;
  }

  /**
   * Reduce una lista de números dividiéndolos.
  ...
  afterReduce(result: number): string | void {
    console.log("El resultado de aplicar \"reduce\" con una división es:", result);
    return "El resultado de aplicar \"reduce\" con una división es: " + result;
  }
}