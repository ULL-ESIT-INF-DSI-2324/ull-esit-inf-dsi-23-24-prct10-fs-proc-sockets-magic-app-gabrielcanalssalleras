 ...
 */
export class FilterMapSubReduce extends TemplateMethod {
  /**
  ...
  beforeReduce(mappedNumbers: number[]): string | void {
    console.log("Vamos a aplicar \"reduce\" con una resta a los números ya filtrados y transformados:", mappedNumbers);
    return "Vamos a aplicar \"reduce\" con una resta a los números ya filtrados y transformados: " + mappedNumbers;
  }

  /**
   * Reduce una lista de números restándolos.
  ...
  afterReduce(result: number): string | void {
    console.log("El resultado de aplicar \"reduce\" con una resta es:", result);
    return "El resultado de aplicar \"reduce\" con una resta es: " + result;
  }
}